...
//        socket.broadcast.emit('new', { message: 'New User was connected' });
        ...
        socket.on('messages', function (data) {
            ...
            socket.broadcast.emit('news', {sender_id: data.sender_id , username: data.username , body: data.body ,receiver_id: data.receiver_id , conversation_id: data.conversation_id});
        });
    });
  return server;
